    ...
    return (
        <>
            <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="mt-6 mb-6 bg-blue-600 text-white px-4 py-2 rounded-md">Send</button>
                </form>

                {status && <p className="mb-6 text-sm text-green-600">{status}</p>} {/* Show status message */}
        </>
    );
};
